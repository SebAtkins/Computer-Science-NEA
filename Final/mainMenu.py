...
class genTerrainMenu:
    ...
    def generate(self):
        print("entry0:", self.entry0.get())
        print("entry1:", self.entry1.get())
        print("entry2:", self.entry2.get())
        print("entry3:", self.entry3.get())
        print("entry4:", self.entry4.get())
        print("entry5:", self.entry5.get())
